...
<body>
  ...
  <div class="mb-5">
    ...
    <input type="text" class="form-control" id="date_entretien" name="date_entretien" placeholder="YYYY-MM-DD">
  </div>
  ...
  <div class="mb-5">
    ...
    <input type="text" class="form-control" id="type_intervention" name="type_intervention"
      placeholder="Ex: Vidange, Freinage...">
  </div>
  ...
  <div class="mb-5">
    ...
    <input type="text" class="form-control" id="prochaine_echeance" name="prochaine_echeance" placeholder="YYYY-MM-DD">
  </div>
              ...
              <div class="card-body">
                ...
                <ul class="list-unstyled mb-0 d-flex flex-column gap-3">
                  <li class="d-flex align-items-start gap-2">
                    ...
                    <span class="small text-muted">Renseignez le titre et le nom du candidat</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <span class="badge bg-primary-subtle text-primary mt-1">2</span>
                    <span class="small text-muted">Choisissez la date, l'heure et le type d'entretien</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <span class="badge bg-primary-subtle text-primary mt-1">3</span>
                    <span class="small text-muted">Définissez le statut actuel de l'entretien</span>
                  </li>
                  <li class="d-flex align-items-start gap-2">
                    <span class="badge bg-primary-subtle text-primary mt-1">4</span>
                    <span class="small text-muted">Ajoutez des notes supplémentaires si nécessaire</span>
                  </li>
                </ul>
              </div>
            </div>
