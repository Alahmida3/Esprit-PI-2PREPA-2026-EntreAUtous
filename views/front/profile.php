    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <div class="ms-auto d-flex gap-2">
                ...
                <a class="btn btn-danger btn-sm" href="/autout/controller/UserController.php?action=logout">
                    ...
                    <div class="card card-custom h-100">
                        <div class="card-body p-4">
                            ...
                            <div id="editMode" class="edit-mode">
                                <form id="formUpdate" action="/autout/controller/UserController.php" method="POST"
                ...
                <div class="col-lg-6">
                    <div class="card card-custom">
                        <div class="card-body p-4">
                            ...
                            <form id="formPassword" action="/autout/controller/UserController.php" method="POST"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="/autout/controller/UserController.php?action=delete_account"
