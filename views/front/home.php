            ...
            <div class="row g-4 justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card module-card p-4 text-center">
                        ...
                        <a href="#" class="btn btn-outline-success btn-sm mt-2">Accéder</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card module-card p-4 text-center">
                        ...
                        <a href="#" class="btn btn-outline-warning btn-sm mt-2">Accéder</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="card module-card p-4 text-center">
                        ...
                        <a href="#" class="btn btn-outline-info btn-sm mt-2">Accéder</a>
                    </div>
                </div>
