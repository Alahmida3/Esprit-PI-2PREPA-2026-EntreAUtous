...
<div class="layout-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav" id="sidebarNav">
            ...
            <a class="sidebar-link" href="/Esprit-PI-2PREPA-2026-EntreAUtous/views/back/listeentretiens.php">
            ...
            <div class="topbar-right">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end shadow-sm">
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li><a class="dropdown-item text-danger" href="/controller/UserController.php?action=logout">
