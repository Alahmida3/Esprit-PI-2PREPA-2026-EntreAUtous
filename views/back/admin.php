...
<div class="layout-wrapper">
    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav" id="sidebarNav">
            ...
            <a class="sidebar-link" href="#navGarages" data-bs-toggle="collapse" aria-expanded="false">
                <span class="s-icon"><i class="ti ti-building"></i></span>
                Garages
                <span class="s-badge bg-success-subtle text-success">Rayen</span>
            </a>
            <div class="collapse sidebar-collapse" id="navGarages">
                <div class="sub-nav">
                    <a class="sidebar-link" href="#">Tous les garages</a>
                    <a class="sidebar-link" href="#">Ajouter un garage</a>
                    <a class="sidebar-link" href="#">Avis & Évaluations</a>
                </div>
            </div>
